    ...
    tags$div(
      ...
      tags$div(
        ...
        tags$p(
          ...
          paste0("Theme: ", preset$label, "  |  BMBA 457: Visual Analytics for Business")
        )
      ),
      ...
      tags$div(
        ...
        HTML("Portfolio Showcase Template &nbsp;&bull;&nbsp; BMBA 457 Visual Analytics for Business &nbsp;&bull;&nbsp; Gonzaga University")
      )
    )
  })
}
