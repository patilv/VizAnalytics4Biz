...
<span class="sandbox-icon">🧪</span> ggplotly Toggle Explorer — Static vs. Interactive
</div>
<iframe class="sandbox-frame" src="https://analytics.gonzaga.edu/content/f36d9e69-d7b9-47bc-b864-f23de1332b23/"
...
::: {.callout-ai}
**AI & This Concept**
When asking AI to make a chart interactive, be specific about *what* the interactivity should reveal. "Add tooltips showing country name and GDP" is much better than "make it interactive." Also specify the output format — `ggplotly()` for quick conversion, or `plot_ly()` for full control.
:::
